...
public class GraphicsTests {
	...
	public void testCreateValidStaticSprite() {
		try {
			...
			new StaticSprite(spritesheet.getSprite(0, 0));
		} catch (GraphicsException e) {
			fail("Should create valid static sprite");
		}
	}
	...
	public void testCreateInvalidStaticSprite1() {
		try {
			SpriteSheet spritesheet = new SpriteSheet("/backgrounds/menu.png", 2, 2);
			new StaticSprite(spritesheet.getSprite(2, 2));
	...
	public void testCreateValidAnimatedSprite1() {
		try {
			SpriteSheet spritesheet = new SpriteSheet("/backgrounds/menu.png", 2, 2);
			new AnimatedSprite(spritesheet.getSprites(0, 0, 0, 1));
		} catch (GraphicsException e) {
			fail("Should create valid static sprite");
		}
	}
	...
	public void testCreateValidAnimatedSprite2() {
		try {
			SpriteSheet spritesheet = new SpriteSheet("/backgrounds/menu.png", 2, 2);
			AnimatedSprite sprite = new AnimatedSprite(spritesheet.getSprites(0, 0, 0, 1));
	...
	public void testCreateValidAnimatedSprite3() {
		try {
			SpriteSheet spritesheet = new SpriteSheet("/backgrounds/menu.png", 2, 2);
			AnimatedSprite sprite = new AnimatedSprite(spritesheet.getSprites(0, 0, 1, 1));
			assertTrue(sprite.getSprites().length == 4);
		} catch (GraphicsException e) {
			e.printStackTrace();
			fail("Should create valid static sprite");
		}
	...
	public void testCreateInvalidAnimatedSprite1() {
		try {
			SpriteSheet spritesheet = new SpriteSheet("/backgrounds/menu.png", 2, 2);
			new AnimatedSprite(spritesheet.getSprites(0, 0, 0, 2));
	...
	public void testCreateInvalidAnimatedSprite2() {
		try {
			SpriteSheet spritesheet = new SpriteSheet("/backgrounds/menu.png", 2, 2);
			new AnimatedSprite(spritesheet.getSprites(0, 2, 0, 0));
			fail("Should not create valid static sprite");
		} catch (GraphicsException e) {
		}
	}
